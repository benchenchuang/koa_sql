...
//更新banner信息
const updateBanner=(id,name,content,url,pic,online,moment)=>{
  let _sql=`update banners set name='${name}',content='${content}',url='${url}',pic='${pic}',online='${online}',moment='${moment}'  where id=${id}`;
  return query(_sql);
}
